...
//station structure, everything that will be pulled from bicing api
public class Station {
    ...
    public String toString() {
        return "Station [is_charging_station=" + is_charging_station + ", last_reported=" + last_reported
                + ", num_bikes_available=" + num_bikes_available + ", num_docks_available=" + num_docks_available
